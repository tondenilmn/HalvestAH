...
// .wrangler/tmp/pages-MvgXow/functionsWorker-0.34363784038735345.mjs
...
__name2(makeBotbotHeaders, "makeBotbotHeaders");
async function onRequest(context) {
  ...
  if (isDebug) {
    ...
    const r = await fetch(url, { headers: makeBotbotHeaders("Q", PINNACLE_HASH) }).catch((e) => ({ ok: false, status: 0, text: /* @__PURE__ */ __name2(async () => e.message, "text") }));
    ...
    const findSample = /* @__PURE__ */ __name2((pattern) => {
...
__name2(extractCallArgs, "extractCallArgs");
...
__name2(parseArgValue, "parseArgValue");
...
__name2(parseGetData2Calls, "parseGetData2Calls");
...
__name2(parseGetData1Calls, "parseGetData1Calls");
...
__name2(parseMatch1HtmlForMeta, "parseMatch1HtmlForMeta");
...
__name2(mergeMatchData, "mergeMatchData");
...
__name2(extractHtmlFromJs, "extractHtmlFromJs");
...
__name2(extractQuotedString, "extractQuotedString");
...
__name2(extractVarFromJs, "extractVarFromJs");
var parseTds = /* @__PURE__ */ __name2((html) => [...html.matchAll(/<td[^>]*>([\s\S]*?)<\/td>/g)].map((m) => m[1]), "parseTds");
var getText = /* @__PURE__ */ __name2((s) => s.replace(/<[^>]+>/g, "").replace(/\s+/g, " ").trim(), "getText");
var pfHtml = /* @__PURE__ */ __name2((s) => {
  const n = parseFloat(getText(s));
  return isNaN(n) ? null : n;
}, "pfHtml");
var getMatchId = /* @__PURE__ */ __name2((html) => {
...
__name2(parseLivegameTables, "parseLivegameTables");
...
__name2(extractHtml, "extractHtml");
function parseMatchData(jsText) {
  ...
  const parseTds2 = /* @__PURE__ */ __name2((html) => [...html.matchAll(/<td[^>]*>([^<]*)<\/td>/g)].map((m) => m[1].trim()), "parseTds");
  const pf = /* @__PURE__ */ __name2((v) => {
...
__name2(parseMatchData, "parseMatchData");
var routes = [
  {
...
// .wrangler/tmp/bundle-w05QAs/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-w05QAs/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.34363784038735345.js.map
