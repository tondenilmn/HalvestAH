...
const BETS = [
  ...
  { k: 'homeScored1H',  label: 'Home scores 1H',  favSideBaseline: 'HOME' },
  { k: 'awayScored1H',  label: 'Away scores 1H',  favSideBaseline: 'AWAY' },
  ...
  { k: 'noBtts',        label: 'BTTS No FT' },
  { k: 'over15FT',      label: 'Over 1.5 FT' },
  { k: 'over25FT',      label: 'Over 2.5 FT' },
  { k: 'over35FT',      label: 'Over 3.5 FT' },
  { k: 'under15FT',     label: 'Under 1.5 FT' },
  { k: 'under25FT',     label: 'Under 2.5 FT' },
  { k: 'homeOver05FT',  label: 'Home Over 0.5 FT', favSideBaseline: 'HOME' },
  { k: 'homeOver15FT',  label: 'Home Over 1.5 FT', favSideBaseline: 'HOME' },
  { k: 'awayOver05FT',  label: 'Away Over 0.5 FT', favSideBaseline: 'AWAY' },
  { k: 'awayOver15FT',  label: 'Away Over 1.5 FT', favSideBaseline: 'AWAY' },
];
...
function processRow(row, fileLabel) {
  ...
  return {
    ...
    over35FT: ftH + ftA >= 4, under15FT: ftH + ftA <= 1, under25FT: ftH + ftA <= 2,
    drawFT: ftH === ftA, btts: ftH >= 1 && ftA >= 1, noBtts: !(ftH >= 1 && ftA >= 1),
    homeOver05FT: ftH >= 1, homeOver15FT: ftH >= 2,
    awayOver05FT: ftA >= 1, awayOver15FT: ftA >= 2,
    favWins1H: favHt > dogHt, draw1H: favHt === dogHt,
    homeWins1H: htH > htA, awayWins1H: htA > htH,
    favScored1H: favHt >= 1, btts1H: htH >= 1 && htA >= 1,
    homeScored1H: htH >= 1, awayScored1H: htA >= 1,
